...
%	(3,4)	to	[V,v=$VCC$]	(1,4)	node[sground]{}	
%	(3,4)	to	(4.5,4)
%	(3,1.5)	to	(4,1.5)
%	
...
\draw
	...
	(0,2.5)	to [R, l_=$ R_G $]	(2,2.5)
	(2,2.5)	to [R, l_=$ R $]	(4,2.5)
...
Luego se comprobó que, la función transferencia del segundo análisis, para frecuencias donde se mantiene constante, se adecua al real.

Por último, la respuesta en frecuencia del último punto mostró 
