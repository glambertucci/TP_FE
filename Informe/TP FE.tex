...
Valiendose del uso de simulaciones en \texttt{ltspice}, se puede usar dichas curvas como teóricas, lo que permite afirmar que, analizando la función transferencia de tensión del circuito, se observa que para la zona constante, el valor calculado es de $43.82 \ dB$, siendo de $43,19 \ dB$ el valor obtenido en la simulación.
...
Una vez efectuados los cálculos, se observa con detenimiento la figura (\ref{fig:bode}). En esta, se muestra el diagrama de BODE del circuito, el cual fue obtenido mediante simulaciones en \texttt{ltspice}, tomando este como el teórico. Por otro lado, se señala en rojo la zona en la cual el análisis realizado es valido (zona roja, coincidente 
