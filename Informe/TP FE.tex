...
Aunque en un primera observación las figuras (\ref{fig:diodorect}) y (\ref{fig:diodozenfab}) se ven diferentes, cabe aclarar que esto se debe a una diferencia de escala utilizada en cada una.
...
\begin{figure}[H]
	...
	\label{fig:diodozen}
\end{figure}
Se comparará las mediciones y la simulación con la datasheet de un diodo zener de 12 V 1n4748A.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{IV-ledFab.PNG}
